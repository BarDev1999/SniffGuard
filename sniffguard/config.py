...
class Config:
    ...
    def __init__(self):
        ...
        self.bpf_filter = self.args.bpf_filter
    ...
    def _parse_args(self) -> argparse.Namespace:
        ...
        from the original sniffer_proj.py
        """
        ...
        parser.add_argument(
            "--log-file",
            default="logs/ids_alerts.log",  # <-- *** CHANGED THIS LINE ***
...
# Any file can now do 'from sniffguard.config import settings'
settings = Config()
